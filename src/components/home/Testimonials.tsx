...
export default function Testimonials({ initialTestimonials }: { initialTestimonials?: TestimonialData[] }) {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {testimonials.map((testimonial, idx) => (
              <motion.div 
                ...
                className="bg-gray-50 p-8 md:p-10 border border-gray-100 flex flex-col relative group hover:bg-primary transition-all duration-500 cursor-default"
              >
