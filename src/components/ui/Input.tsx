...
export default function Input({ label, error, info, className = '', ...props }: InputProps) {
  return (
    <div className="flex flex-col gap-1.5 w-full">
      ...
      <input
        {...props}
        className={`px-4 py-3 border-b-2 outline-none transition-all text-sm font-bold placeholder:text-gray-200 ${
          error 
