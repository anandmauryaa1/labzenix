...
export default function ApplicationCategoryManagement() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setServerError(null);
    try {
      const url = editingId ? `/api/application-categories/${editingId}` : '/api/application-categories';
  ...
  async function deleteCategory(id: string) {
    if (!confirm('Are you sure? This might affect applications using this category.')) return;
    ...
    <div className="space-y-8 animate-in fade-in duration-500 relative">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-3xl font-black text-secondary tracking-tighter uppercase mb-2">Application Categories</h1>
            ...
            <div className="bg-white border border-gray-100 p-8 shadow-sm space-y-6">
              <div className="flex items-center justify-between border-b border-gray-100 pb-4">
                <h3 className="text-xs font-black uppercase tracking-widest text-secondary flex items-center">
                  ...
                  {editingId ? 'Refine Category' : 'Define New Category'}
                </h3>
                <button 
                  onClick={() => {
                    setIsAdding(false);
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-4 pt-4 border-t border-gray-100">
                  ...
                  {form.image ? (
                    <div className="relative w-full aspect-video bg-gray-100 border border-gray-100 overflow-hidden group">
                    ...
                    <label className={`w-full border-2 border-dashed rounded-sm p-8 flex flex-col items-center justify-center transition-all cursor-pointer ${
                      ...
                      {isImageUploading ? (
                        ...
                        <>
                          ...
                          <span className="text-[10px] font-black uppercase tracking-widest text-gray-400 group-hover:text-primary">Click to Upload Category Image</span>
                        </>
                      )}
                    </label>
                  )}
                ...
                >
                  ...
                  <span>{editingId ? 'Apply Refinements' : 'Deploy Category'}</span>
                </button>
              </form>
            </div>
          </div>
