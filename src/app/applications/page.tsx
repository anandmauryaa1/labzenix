      ...
      <section className="py-24 px-4">
        <div className="max-w-7xl mx-auto">
          <FadeIn direction="up" className="text-center max-w-3xl mx-auto mb-20">
            <span className="text-primary font-black tracking-[0.3em] uppercase text-[10px] mb-4 block">Our Expertise</span>
            <h2 className="text-4xl md:text-6xl font-black text-secondary uppercase tracking-tighter leading-none mb-6">
              Precision Solutions for <span className="text-primary">Every</span> Industry
            </h2>
