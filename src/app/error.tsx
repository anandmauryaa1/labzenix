    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6">
      <div className="max-w-md w-full bg-white border border-gray-100 shadow-2xl p-10 text-center space-y-8 animate-in fade-in zoom-in duration-500">
        ...
        <div className="flex flex-col space-y-3">
          ...
          <Link 
            href="/" 
            className="flex items-center justify-center space-x-3 w-full py-4 border border-gray-100 text-gray-400 text-[10px] font-black uppercase tracking-[0.2em] hover:bg-gray-50 transition-all"
